    ...
    <div id="platforms">
        ...
        <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
            ...
            <div
                ...
                <button
                    class="!absolute top-4 right-4 h-8 max-h-[32px] w-8 max-w-[32px] select-none rounded-full text-center align-middle font-sans text-xs font-medium uppercase text-white transition-all hover:bg-red-500/10 active:bg-red-500/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                    type="button">
                ...
                <div class="inline-flex flex-wrap items-center gap-3 mt-8 group">
                    @foreach ($platforms as $platform)
                        <span
                            ...
                            <img src="{{ asset('images/' . $platform->name . '.png') }}" alt="" class="w-5 h-5">
                        </span>
                    @endforeach
                </div>
            </div>
